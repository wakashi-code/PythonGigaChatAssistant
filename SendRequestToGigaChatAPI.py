...
giga = GigaChat(credentials=SetGigaChatVariables.GIGACHAT_CREDENTIALS, model=SetGigaChatVariables.GIGACHAT_MODEL, verify_ssl_certs=False)


url = "https://gigachat.devices.sberbank.ru/"

payload = {'scope': SetGigaChatVariables.GIGACHAT_SCOPE}
headers = {
